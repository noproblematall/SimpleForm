...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href="{{route('frontend')}}">FORM</a></div>
      ...
      <ul class="br-sideleft-menu">
        <li class="br-menu-item">
          <a href="{{route('home')}}" class="br-menu-link {{ $active==='home' ? 'active' : null }}">
            ...
            <span class="menu-item-label">Form Data</span>
          </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
        {{-- <li class="br-menu-item">
        ...
        <nav class="nav">         
          <div class="dropdown">
            <a href="javascript:void(0);" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down">{{$user->name}}</span>
              <img src="{{asset('img/avatar.png')}}" class="wd-32 rounded-circle" alt="">
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <img src="{{asset('img/avatar.png')}}" class="wd-80 rounded-circle" alt="">
